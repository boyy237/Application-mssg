...
android {
    namespace = "com.ciphertalk.messenger"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.ciphertalk.messenger"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"

        // Adresse de base de votre serveur backend.
...
dependencies {
    ...
    // Réseau : appels REST (Retrofit) + WebSocket temps réel (OkHttp)
